...
const shapeCalculators: Record<string, ShapeCalculator> = {
  lines: ({ start, end }: { start: IPoint; end: IPoint }): any => {
    const spx = start.x;
    const spy = start.y;
    const epx = end.x;
    const epy = end.y;
  ...
  arcs: ({ start, end }: { start: IPoint; end: IPoint }): any => {
  ...
  diamonds: ({ start, end }: { start: IPoint; end: IPoint }): any => {
    const spx = start.x;
    const spy = start.y;
    const epx = end.x;
    const epy = end.y;
  ...
  squares: ({ start, end }: { start: IPoint; end: IPoint }): any => {
    const spx = start.x;
    const spy = start.y;
    const epx = end.x;
    const epy = end.y;
  ...
  rhomboids: ({ start, end }: { start: IPoint; end: IPoint }): any => {
    const spx = start.x;
    const spy = start.y;
    const epx = end.x;
    const epy = end.y;
  ...
  circles: ({ start, end }: { start: IPoint; end: IPoint }): any => {
    const spx = start.x;
    const spy = start.y;
    const epx = end.x;
    const epy = end.y;
  ...
  rectangles: ({ start, end }: { start: IPoint; end: IPoint }): any => {
    const spx = start.x;
    const spy = start.y;
    const epx = end.x;
    const epy = end.y;
  ...
  triangles: ({ start, end }: { start: IPoint; end: IPoint }): any => {
    const spx = start.x;
    const spy = start.y;
    const epx = end.x;
    const epy = end.y;
